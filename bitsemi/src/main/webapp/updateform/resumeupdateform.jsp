...
<div class="resume_wrapper">
    <form action="#" method="post" id="resume_updateform" class="resume_updateform">
        <input type="hidden" name="num" value="${resume.num}"> <%--넘버 들어갈 곳--%>
        ...
        <div class="resume_body">
            ...
            <div class="resume_contents">
                ...
                <label>
                    PhoneNumber<br>
                    <input type="text" name="phonenum" value="${resume.phonenum}" required />
                </label>
                ...
                <label>
                    ...
                    <input type='text' name="jobtype2" value="${resume.jobtype}">
                </label>
                ...
                <label>
                    Carrer<br>
                    <input type="text" name="career" value="${resume.career}"/>
                </label>
                <label>
                    Address<br>
        ...
        <div class="resume_footer">
            ...
            <div class="resume_contents">
                <textarea name="introduce">${resume.introduce}</textarea>
            </div>
        </div>
        ...
        <div class="resume_button">
            <button type="submit" class="resume_updatebutton">이력서 수정하기</button>
