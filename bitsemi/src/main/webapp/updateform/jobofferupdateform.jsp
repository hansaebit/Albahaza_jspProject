...
<div class="jobofferform_wrapper">
    <input type="hidden" name="xpoint" value="${joboffer.xpoint}">
    <input type="hidden" name="ypoint" value="${joboffer.ypoint}">
    <form method="post" class="joboffer_updateform">
        <input type="hidden" name="num" value="${joboffer.num}"> <%--넘버 들어갈 곳--%>
        <input type="hidden" name="id" value="${joboffer.id}"> <%--아이디 들어갈 곳--%>
        ...
        <div class="jobofferform_body">
            ...
            <div class="jobofferform_contents">
                <label>
                    CompanyName<br>
                    <input type="text" name="companyname" value="${joboffer.companyname}" required/>
                </label>
                <label>
                    PhoneNumber<br>
                    <input type="text" name="phonenum" value="${joboffer.phonenum}" required/>
                </label>
                <label>
                    JobType<br>
                    <select name="Jobtype1">
                    ...
                    <input type="text"  name="jobtype" value="${joboffer.jobtype}" required/>
                </label>
                <lable>
                    Term<br>
                    <label>
                        <input type='radio' name='term' value='장기'/>
                        장기
                    </label>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                ...
                <label>
                    Pay<br>
                    <input type="text" name="pay" value="${joboffer.pay}" required/>
                </label>
                <label>
                    Need People<br>
                    <input type="text" name="needpeople" value="${joboffer.needpeople}" required/>
                </label>
                <label>
                    Address<br>
        ...
        <div class="jobofferform_body">
            ...
            <div class="jobofferform_contents">
                ...
                <input type="hidden" name="xpoint" id="message1" />
                <input type="hidden" name="ypoint" id="message2" />
            </div>
        </div>
        ...
        <div class="jobofferform_footer">
            ...
            <div class="jobofferform_contents">
                <textarea name="introduce">${joboffer.introduce}</textarea>
            </div>
        </div>
